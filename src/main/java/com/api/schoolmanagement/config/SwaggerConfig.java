package com.api.schoolmanagement.config;
...
@Configuration //@configuration - It @EnableSwagger2 annotations to enable the framework for your Spring Boot application.
